...
<head>
	...
	<!-- Title -->
	<title>RedPro | Administrador</title>
				...
				<div class="container-fluid">
					<div class="d-flex">
						<a class="header-brand" href="index.php?page=inicio">
							<img src="../assets/img/logo/logo.jpeg" width="65" height="65" alt="Business logo">
						</a>
						...
						<div class="d-flex order-lg-2 ml-auto">
							...
							<div class="dropdown ">
								<a href="#" class="nav-link pr-0 leading-none user-img" data-toggle="dropdown">
									<img src="../assets/images/faces/2.jpg" alt="profile-img" class="avatar avatar-md brround">
								</a>
			...
			<aside class="app-sidebar doc-sidebar">
				<div class="app-sidebar__user clearfix">
					<div class="dropdown user-pro-body">
						<div>
							<img src="../assets/images/faces/2.jpg" alt="user-img" class="avatar avatar-lg brround">
