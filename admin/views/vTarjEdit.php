                ...
                <div class="row">
                    ...
                    <!-- <div class="col-sm-12 col-md-6">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="facebook" placeholder="facebook" hidden>
                        <!-- </div>
                        <br>
                    </div>
                    <div class="col-sm-12 col-md-6">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="instagram" placeholder="instagram" hidden>
                        <!-- </div>
                        <br>
                    </div>
                    <div class="col-sm-12 col-md-6">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="linkedin" placeholder="linkedin" hidden>
                        <!-- </div>
                        <br>
                    </div>
                    ...
                    <div class="col-sm-12 col-md-6">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="tiktok" placeholder="tiktok" hidden>
                        <!-- </div>
                    </div>
                    <div class="col-sm-12 col-md-6">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="youtube" placeholder="youtube" hidden>
                        <!-- </div>
                    </div> -->

                    <div class="col-sm-12 col-md-12">
                        <h4><br>Dirección Física<br> &nbsp;</h4>
                    </div>
                    <div class="col-sm-12 col-md-6">
                        <div class="form-group">
