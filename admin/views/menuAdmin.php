	<ul class="side-menu">
		...
		<!-- Home -->
			<li class="slide <?php if ($pagina == 'inicio') echo 'is-expanded'; ?>">
				...
				<a class="side-menu__item <?php if ($pagina == 'vNuevaCita') echo 'active'; ?>" 
				href="index.php?page=vNuevaCita"><i class="side-menu__icon fa fa-id-card-o"></i><span class="side-menu__label">Nuevo Perfil</span></a>
