...
class CitasController
{
    ...
    public static function registraCita()
    {
        if (isset($_POST["btnRegistrar"])) {
            ...
            if (!empty($ingresa)){
                ...
                $folderBD = $ingresa . "-" .$nombreCompleto;
    ...
    #-----------------------------------------------
    # EDICION DE REGISTRO DE PERFIL DIGITAL
    #-----------------------------------------------
    public static function ctrActualiza()
    {
        if (isset($_POST["btnActualiza"])) {
            ...
            //elimina caracteres de la mascara en el numero de telefono
            $eliminar = array("(", ")", "-", " ");
            $telefono = str_replace($eliminar, "", $_POST["telefonoFijo"]);
            $whatsapp = str_replace($eliminar, "", $_POST["telefonoMovil"]);
            ...
            $actualiza = CitasModel::actualizaPerfil($datos);                        
    ...
    # ==============================================
    # BUSCA LA INFORMACION DE UN PERFIL/SOCIO 
    # ==============================================

	public static function buscaPerfil($perfil, $tabla){

		$stmt = Conexion::conectar()->prepare("SELECT * FROM $tabla WHERE id = :id");

		$stmt->bindParam(":id", $perfil, PDO::PARAM_INT);
