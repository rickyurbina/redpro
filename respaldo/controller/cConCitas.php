...
class CitasController
{
    ...
    public static function registraCita()
    {
        if (isset($_POST["btnRegistrar"])) {
            ...
            $puesto = $_POST['puesto'];  
            $colorPrimario = ($_POST['colorPrimario'] != "")? $_POST['colorPrimario']: '#FB0099';
            $colorSecundario = ($_POST['colorSecundario'] != "") ? $_POST['colorSecundario']: '#4B3240';
            ...
            $biografia = ($_POST['bio']) ? '<section class="page-section portolio mb-0" id="about">
                                        <div class="container">
                        ...
                        <html lang="en">
                            ...
                            <body id="page-top">
                                ...
                                <div class="copyright py-4 text-center text-white">
                                    <div class="container"><small>Copyright &copy; Tap Id 2023</small></div>
                                </div>
    ...
    echo "Resultados: ".$ingresa . "<br>". $uploadOk ."<br>".$registrado;      
            ...
            if ($ingresa == "ok" && $uploadOk == 1 && $registrado == 0) {
