<div class="page-header">
	<div class="card-options" style="margin-right: 100px;">
		...
		<a class="btn btn-cyan btn-lg mb-1" href="index.php?page=vUserAdd"><i class="fa fa-user-plus" data-toggle="tooltip" title="Agregar Nuevo Usuario" data-original-title="fa fa-user-plus"></i></a>&nbsp
