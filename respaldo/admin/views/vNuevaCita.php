    ...
    <div class="col-lg-8">
        <form class="card" method="POST" enctype="multipart/form-data">
            <div class="card-header">
                <h3 class="card-title">Nuevo Perfil </h3>
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-4">
                        ...
                        <input class="form-control" type = "text" name="colorPrimario" placeholder = "ej.   #456456" />
                    </div>
                    <div class="col-sm-12 col-md-4">
                        <label class="form-label">Color Secundario</label>
                        <input class="form-control" type = "text" name="colorSecundario" placeholder = "ej.   #456456" />
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-12">
                        <div class="form-group">
                            <label class="col-form-label">Acerca de mí | Biografía </label>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-5">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="telefonoFijo" data-inputmask="'mask' : '(999) 999-9999'">
                        </div>
                    </div>
