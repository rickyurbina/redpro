...
Class CitasModel{
    ...
    public static function registraCita($datos){
        $stmt = Conexion::conectar()->prepare("INSERT INTO `solicitudes` (`id`, `responsable`, `cliente`, `telefono`, `fecha`, `estado`)
        VALUES (NULL, :responsable, :cliente, :telefonoMovil, :fecha, 'N');");
        ...
        $stmt -> bindParam(":telefonoMovil", $datos["telefonoMovil"], PDO::PARAM_STR);
